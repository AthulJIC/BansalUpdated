    ...
    return(
        <View style={{flex:1,backgroundColor:'white'}}>
            ...
            <View style={styles.inputContainer}>
               <Text style={{fontSize:16,fontFamily:'Poppins-Regular',color:'rgba(57, 57, 57, 1)'}}>Abhiram Ahuja</Text>
            </View>
            <View style={styles.inputContainer}>
               <Text style={{fontSize:16,fontFamily:'Poppins-Regular',color:'rgba(57, 57, 57, 1)'}}>9863528394</Text>
            </View>
            <View style={styles.inputContainer}>
               <Text style={{fontSize:16,fontFamily:'Poppins-Regular',color:'rgba(57, 57, 57, 1)'}}>Bhopal</Text>
            </View>
            <View style={styles.inputContainer}>
               <Text style={{fontSize:16,fontFamily:'Poppins-Regular',color:'rgba(57, 57, 57, 1)'}}>45 Ton</Text>
            </View>
            ...
            <View style={styles.modalButtonContainer}>
                <TouchableOpacity style={{ marginBottom: 10, borderRadius: 5, width: '100%', backgroundColor: 'rgba(177, 41, 44, 1)C', alignItems: 'center', height: 48, radius: 4, padding: 12 }} >
                    <Text style={{ fontFamily: 'Poppins', fontWeight: '500', fontSize: 16, lineHeight: 24, color: '#ffffff', height: 24 ,fontFamily:'Poppins-Regular'}}>
                        Confirm Details
                    </Text>
                </TouchableOpacity>
            </View>
            <ReferLead isVisible={modalVisible} onClose={closeModal}/>
        </View>
    )
}
