...
function ForgetPasswordScreen(){
    return(
        <View style={{flex:1, backgroundColor:'white'}}>
            <Text style={{fontSize:19,textAlign:'justify',width:'93%',alignSelf:'center',color:'rgba(57, 57, 57, 1)', fontFamily:'Poppins-Regular'}}>Please Connect with the sales team to reset password</Text>
